    ...
    <div class=\"operation-form__type-box\">
      ";
          ...
          <input type=\"radio\" name=\"type_id\" value=\"";
                // line 20
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["type"], "id", [], "any", false, false, true, 20), 20, $this->source), "html", null, true);
                yield "\" hidden>
          <span class=\"operation-form__type-box__name\">";
                // line 21
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["type"], "name", [], "any", false, false, true, 21), 21, $this->source), "html", null, true);
                yield "</span>
        </label>
      ";
            }
...
";
  ...
  window.prefill_products = ";
                // line 173
                yield json_encode($this->sandbox->ensureToStringAllowed(($context["prefill_products"] ?? null), 173, $this->source));
                yield ";
  window.prefill_note_id = ";
                // line 174
                yield json_encode($this->sandbox->ensureToStringAllowed(($context["note_id"] ?? null), 174, $this->source));
                yield ";
</script>
";
            }
...
";
            ...
            // line 179
            yield "    <p>У вас нет прав для добавления новой операцииxxxxx.</p>
";
        }
        yield from [];
    }
    ...
    {
        return array (  282 => 179,  278 => 177,  272 => 174,  268 => 173,  265 => 172,  263 => 171,  260 => 170,  251 => 162,  243 => 155,  240 => 153,  237 => 151,  188 => 103,  181 => 97,  178 => 95,  175 => 93,  152 => 71,  137 => 57,  114 => 35,  103 => 25,  101 => 24,  92 => 21,  88 => 20,  85 => 19,  81 => 18,  73 => 13,  68 => 10,  66 => 9,  63 => 8,  56 => 6,  53 => 5,  50 => 4,  46 => 3,  44 => 2,);
    }
...
{% else %}
    <p>У вас нет прав для добавления новой операцииxxxxx.</p>
{% endif %}", "C:\\OSPanel\\domains\\inventpro\\themes\\invent-pro\\pages\\add-operation.htm", "");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = ["escape" => 13, "slice" => 18, "raw" => 173, "json_encode" => 173];
        static $functions = [];
