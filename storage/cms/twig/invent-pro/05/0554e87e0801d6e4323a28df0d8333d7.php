...
/* C:\OSPanel\domains\inventpro\themes\invent-pro\pages\edit-operation.htm */
class __TwigTemplate_0b6bb2f5210813624d88d4fa904d842b extends Template
{
    ...
    <div class=\"operation-form__type-box\">
      ";
          ...
          <input type=\"radio\" name=\"type_id\" value=\"";
                // line 12
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["type"], "id", [], "any", false, false, true, 12), 12, $this->source), "html", null, true);
                yield "\" hidden>
          <span class=\"operation-form__type-box__name\">";
                // line 13
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["type"], "name", [], "any", false, false, true, 13), 13, $this->source), "html", null, true);
                yield "</span>
        </label>
      ";
            }
...
";
    ...
    {
        return "C:\\OSPanel\\domains\\inventpro\\themes\\invent-pro\\pages\\edit-operation.htm";
    }
    ...
    {
        return array (  242 => 164,  237 => 161,  228 => 153,  220 => 146,  217 => 144,  214 => 142,  166 => 95,  159 => 89,  156 => 87,  153 => 85,  130 => 63,  115 => 49,  92 => 27,  81 => 17,  79 => 16,  70 => 13,  66 => 12,  63 => 11,  59 => 10,  51 => 5,  46 => 2,  44 => 1,);
    }
...
{% endif %}", "C:\\OSPanel\\domains\\inventpro\\themes\\invent-pro\\pages\\edit-operation.htm", "");
    }
    
    public function checkSecurity()
    {
        static $tags = ["if" => 1, "for" => 10];
        static $filters = ["escape" => 5, "slice" => 10];
        static $functions = [];
