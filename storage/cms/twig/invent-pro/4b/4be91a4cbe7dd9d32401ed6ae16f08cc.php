...
/* C:\OSPanel\domains\inventpro\themes\invent-pro\pages\documents.htm */
class __TwigTemplate_fb8c6cefb5d11c4f93b642ba4d3cd5f9 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield "<div class=\"documents-list\">
...
";
    ...
    ";
            // line 7
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["doc"] ?? null), "doc_file_flag", [], "any", false, false, true, 7)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 8
        ...
        <span>Операция не подтверждена, <b>не загружен PDF</b></span>
      </div>
    ";
            }
            // line 15
      ...
      <div class=\"documents-item__top\">
        ...
        <div class=\"documents-item__top-left\">
          ...
          <div class=\"documents-item__type label--type-operation\">
            ...
            ";
            // line 22
            if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "type", [], "any", false, false, true, 22), "name", [], "any", false, false, true, 22) == "Приход")) {
                // line 23
...
$context["operation"], "type", [], "any", false, false, true, 28), "name", [], "any", false, false, true, 28) == "Списание")) {
                // line 29
...
$context["operation"], "type", [], "any", false, false, true, 35), "name", [], "any", false, false, true, 35) == "Передача")) {
                // line 36
          ...
          <div class=\"documents-item__top-info\">
            ...
            <div class=\"documents-item__date\">
              ";
            // line 48
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "documents", [], "any", false, false, true, 48)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 49
                yield "
                ...
                ";
                // line 60
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "first_document_date", [], "any", false, false, true, 60), 60, $this->source), "html", null, true);
                yield "
            ...
            <div class=\"documents-item__counteragent\">
              ";
            // line 66
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "first_counteragent", [], "any", false, false, true, 66), 66, $this->source), "html", null, true);
            yield "
            </div>
        ...
        <div class=\"documents-item__number\">
          ";
            // line 74
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "first_document", [], "any", false, false, true, 74)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 75
                yield "            № ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "first_document", [], "any", false, false, true, 75), "doc_num", [], "any", false, false, true, 75), 75, $this->source), "html", null, true);
                yield "
          ";
            }
            // line 77
      ...
      <div class=\"documents-item__middle\">
        ...
        <div class=\"documents-item__purpose\">
          ...
          ";
            // line 85
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "documents", [], "any", false, false, true, 85)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 86
                yield "              <p>";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "first_document", [], "any", false, false, true, 86), "doc_purpose", [], "any", false, false, true, 86), 86, $this->source), "html", null, true);
                yield "</p>
          ";
            }
            // line 88
      ...
      <div class=\"documents-item__bottom\">
        ...
        ";
            // line 95
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "products", [], "any", false, false, true, 95), "count", [], "any", false, false, true, 95)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 96
                yield "
          ";
                // line 97
                $context["count"] = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "products", [], "any", false, false, true, 97), "count", [], "any", false, false, true, 97);
                // line 98
                yield "          ";
          ...
          ";
                ...
                if (((($context["n"] ?? null) > 10) && (($context["n"] ?? null) < 20))) {
                    // line 102
                    yield "              ";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(($context["count"] ?? null), 102, $this->source), "html", null, true);
                    yield " товаров
          ";
                } elseif ((                // line 103
($context["n1"] ?? null) == 1)) {
                    // line 104
                    yield "              ";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(($context["count"] ?? null), 104, $this->source), "html", null, true);
                    yield " товар
          ";
                } elseif (((                // line 105
($context["n1"] ?? null) >= 2) && (($context["n1"] ?? null) <= 4))) {
                    // line 106
                    yield "              ";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(($context["count"] ?? null), 106, $this->source), "html", null, true);
                    yield " товара
          ";
                } else {
                    // line 108
                    yield "              ";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(($context["count"] ?? null), 108, $this->source), "html", null, true);
                    yield " товаров
          ";
                }
                // line 110
        ...
        <a href=\"/documents/";
            // line 113
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["operation"], "slug", [], "any", false, false, true, 113), 113, $this->source), "html", null, true);
            yield "\" class=\"button--md button--brand\">Детальніше</a>
...
";
    ...
    {
        return "C:\\OSPanel\\domains\\inventpro\\themes\\invent-pro\\pages\\documents.htm";
    }
    ...
    {
        return array (  259 => 120,  252 => 118,  249 => 116,  244 => 113,  241 => 112,  237 => 110,  231 => 108,  225 => 106,  223 => 105,  218 => 104,  216 => 103,  211 => 102,  209 => 101,  206 => 100,  203 => 99,  200 => 98,  198 => 97,  195 => 96,  193 => 95,  187 => 91,  183 => 88,  177 => 86,  175 => 85,  168 => 80,  165 => 78,  163 => 77,  157 => 75,  155 => 74,  151 => 72,  148 => 70,  142 => 66,  138 => 64,  136 => 63,  130 => 60,  117 => 49,  115 => 48,  109 => 44,  106 => 42,  98 => 36,  96 => 35,  88 => 29,  86 => 28,  79 => 23,  77 => 22,  68 => 15,  59 => 8,  57 => 7,  52 => 4,  48 => 3,  44 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("<div class=\"documents-list\">
...
{% for operation in operations %}
    ...
    {% endif %}
      ...
      <div class=\"documents-item__top\">
        ...
        <div class=\"documents-item__number\">
          {% if operation.first_document %}
            № {{ operation.first_document.doc_num }}
          {% endif %}
      ...
      <div class=\"documents-item__middle\">
        ...
        <div class=\"documents-item__purpose\">
          Підстава:
          {% if operation.documents %}
              <p>{{ operation.first_document.doc_purpose}}</p>
          {% endif %}
        </div>
      ...
      <div class=\"documents-item__bottom\">
        ...
        <div class=\"documents-item__count\">
        {% if operation.products.count %}

          {% set count = operation.products.count %}
          {% set n = count % 100 %}
          {% set n1 = n % 10 %}
        ...
        <a href=\"/documents/{{ operation.slug }}\" class=\"button--md button--brand\">Детальніше</a>
...
{% endfor %}
</div>{# documents-list #}", "C:\\OSPanel\\domains\\inventpro\\themes\\invent-pro\\pages\\documents.htm", "");
    }
    
    public function checkSecurity()
    {
        static $tags = ["for" => 3, "if" => 7, "set" => 97];
