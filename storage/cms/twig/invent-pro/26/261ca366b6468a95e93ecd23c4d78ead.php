...
/* C:\OSPanel\domains\inventpro-test\themes\invent-pro\pages\add-operation.htm */
class __TwigTemplate_5d9f9bfb739dcedf8196d6715d515ef2 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield "<div class=\"container--sm box--light\">

  <h2 class=\"operation-form__title\">";
        // line 3
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 3), "title", [], "any", false, false, true, 3), 3, $this->source), "html", null, true);
        yield "</h2>
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["type"]) {
          ...
          <input type=\"radio\" name=\"type_id\" value=\"";
            // line 10
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["type"], "id", [], "any", false, false, true, 10), 10, $this->source), "html", null, true);
            yield "\" hidden>
          <span class=\"operation-form__type-box__name\">";
            // line 11
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["type"], "name", [], "any", false, false, true, 11), 11, $this->source), "html", null, true);
            yield "</span>
        </label>
      ";
        }
        ...
        <div class=\"operation-form__row--document\">
          ...
          <div class=\"operation-form__row--document-top\">
            ...
            <div class=\"form-floating operation-form__input--doc-name\">
              <input type=\"text\" name=\"doc_name[]\" class=\"form-input\" placeholder>
...
";
  ...
  window.prefill_products = ";
            // line 163
            yield json_encode($this->sandbox->ensureToStringAllowed(($context["prefill_products"] ?? null), 163, $this->source));
            yield ";
  window.prefill_note_id = ";
            // line 164
            yield json_encode($this->sandbox->ensureToStringAllowed(($context["note_id"] ?? null), 164, $this->source));
            yield ";
</script>
";
        }
    ...
    {
        return "C:\\OSPanel\\domains\\inventpro-test\\themes\\invent-pro\\pages\\add-operation.htm";
    }
    ...
    {
        return array (  247 => 164,  243 => 163,  240 => 162,  238 => 161,  235 => 160,  226 => 152,  218 => 145,  215 => 143,  212 => 141,  163 => 93,  156 => 87,  153 => 85,  150 => 83,  127 => 61,  112 => 47,  89 => 25,  78 => 15,  76 => 14,  67 => 11,  63 => 10,  60 => 9,  56 => 8,  48 => 3,  44 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("<div class=\"container--sm box--light\">
...
{% endif %}", "C:\\OSPanel\\domains\\inventpro-test\\themes\\invent-pro\\pages\\add-operation.htm", "");
    }
    
    public function checkSecurity()
    {
        static $tags = ["for" => 8, "if" => 161];
        static $filters = ["escape" => 3, "slice" => 8, "raw" => 163, "json_encode" => 163];
        static $functions = [];

        try {
            $this->sandbox->checkSecurity(
                ['for', 'if'],
                ['escape', 'slice', 'raw', 'json_encode'],
                [],
                $this->source
            );
