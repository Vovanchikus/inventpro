...
/* C:\OSPanel\domains\inventpro-test\themes\invent-pro\partials\global\bottom-bar.htm */
class __TwigTemplate_726110b78581ef992ca57ee5cddfb4b8 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 1), "url", [], "any", false, false, true, 1) != "/add-operation")) {
            // line 2
            yield "
<div id=\"categoryMenuOverlay\" class=\"category-menu__overlay hidden\"></div>
...
<div id=\"bottomBar\" class=\"bottom-bar hidden\">
  ...
  <div class=\"bottom-bar__left\">
    ...
    <div class=\"bottom-bar__count-box\">
      <div id=\"bottomBarCount\" class=\"bottom-bar__count label--secondary\">4</div>
      <div class=\"bottom-bar__count-text\">товари вибрано</div>
    </div>
  ...
  <div class=\"bottom-bar__button-box\">
    ...
    ";
            ...
            if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 25), "url", [], "any", false, false, true, 25) == "/operation-history")) {
                // line 26
                yield "      <button type=\"submit\" id=\"editOperation\" class=\"button button--nm button--brand\">
    ...
    ";
        ...
        <button type=\"submit\" id=\"addToCategory\" class=\"button button--nm button--secondary button--ico-left\" title=\"Дать категорию\">
          <svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">
        ...
        <div id=\"categoryMenu\" class=\"category-menu hidden\">
          <ul class=\"category-menu__list\">
              ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
                    ...
                    if ((CoreExtension::getAttribute($this->env, $this->source, $context["cat"], "nest_depth", [], "any", false, false, true, 47) == 0)) {
                        ...
                        if ((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["cat"], "children", [], "any", false, false, true, 51))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                            ...
                            // line 70
                            $context['_parent'] = $context;
                            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["cat"], "children", [], "any", false, false, true, 70));
                            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                                // line 71
                                yield "                                      <li class=\"category-menu__item\" data-id=\"";
                                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["child"], "id", [], "any", false, false, true, 71), 71, $this->source), "html", null, true);
                                yield "\">
                                          <div class=\"category-menu__item-left\">";
                                // line 72
                                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["child"], "name", [], "any", false, false, true, 72), 72, $this->source), "html", null, true);
                                yield "<span>";
                                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["child"], "desc", [], "any", false, false, true, 72), 72, $this->source), "html", null, true);
                                yield "</span></div>

                                          ";
                                // line 74
                                if ((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["child"], "children", [], "any", false, false, true, 74))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                                    // line 75
                                    yield "                                              <div class=\"category-menu__item-arrow\">
                                                  <svg width=\"20\" height=\"20\" viewBox=\"0 0 24 24\" fill=\"none\"
                                                      xmlns=\"http://www.w3.org/2000/svg\">
                                    ...
                                    // line 93
                                    $context['_parent'] = $context;
                                    $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["child"], "children", [], "any", false, false, true, 93));
                                    foreach ($context['_seq'] as $context["_key"] => $context["subchild"]) {
                                        // line 94
                                        yield "                                                      <li class=\"category-menu__item\" data-id=\"";
                                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["subchild"], "id", [], "any", false, false, true, 94), 94, $this->source), "html", null, true);
                                        yield "\">
                                                          <div class=\"category-menu__item-left\">";
                                        // line 95
                                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["subchild"], "name", [], "any", false, false, true, 95), 95, $this->source), "html", null, true);
                                        yield "<span>";
                                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["subchild"], "desc", [], "any", false, false, true, 95), 95, $this->source), "html", null, true);
                                        yield "</span></div>
                                                      </li>
                                                  ";
                                    }
                ...
                // line 113
                yield "
      <button type=\"submit\" id=\"addToNote\" class=\"button button--nm button--secondary button--ico-left\" title=\"Добавить в заметку\">
        <svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">
      ...
      <div class=\"bottom-bar__create\">
        <button type=\"button\" id=\"createOperationDropdownToggle\" class=\"button button--nm button--brand button--ico-left\">
          <svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">
        ...
        <div id=\"createOperationDropdownMenu\" class=\"bottom-bar__create-menu dropdown\">
          <button type=\"button\" id=\"createNote\" class=\"bottom-bar__create-item\">С заметкой</button>
          <button type=\"button\" id=\"createOperationDirect\" class=\"bottom-bar__create-item\">Без заметки</button>
        </div>
      </div>
    ";
            }
...
";
    ...
    {
        return "C:\\OSPanel\\domains\\inventpro-test\\themes\\invent-pro\\partials\\global\\bottom-bar.htm";
    }
    ...
    {
        return array (  261 => 138,  258 => 136,  255 => 134,  232 => 113,  225 => 107,  219 => 106,  215 => 104,  211 => 102,  204 => 100,  200 => 98,  189 => 95,  184 => 94,  180 => 93,  160 => 75,  158 => 74,  151 => 72,  146 => 71,  142 => 70,  122 => 52,  120 => 51,  113 => 49,  108 => 48,  105 => 47,  101 => 46,  89 => 36,  87 => 35,  84 => 34,  74 => 26,  72 => 25,  67 => 22,  46 => 2,  44 => 1,);
    }
...
<div id=\"bottomBar\" class=\"bottom-bar hidden\">
  ...
  <div class=\"bottom-bar__button-box\">
    ...
    {% if this.page.url == '/operation-history' %}
      <button type=\"submit\" id=\"editOperation\" class=\"button button--nm button--brand\">
        <svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">
          <path d=\"M16.7216 1.13459C17.2739 0.955135 17.8688 0.955135 18.4212 1.13459C18.7811 1.25156 19.0808 1.4563 19.3714 1.70298C19.6499 1.93948 19.9652 2.25473 20.3429 2.63242L20.8604 3.15C21.2382 3.5277 21.5534 3.84297 21.79 4.12157C22.0366 4.41213 22.2414 4.71178 22.3583 5.07178C22.5378 5.6241 22.5378 6.21905 22.3583 6.77137C22.2414 7.13136 22.0366 7.43101 21.79 7.72158C21.5534 8.00017 21.2382 8.31541 20.8605 8.6931L19.8676 9.68603C19.6696 9.88404 19.5705 9.98304 19.4564 10.0201C19.356 10.0528 19.2478 10.0528 19.1474 10.0201C19.0332 9.98304 18.9342 9.88404 18.7362 9.68603L13.8069 4.75674C13.6089 4.55873 13.5099 4.45973 13.4728 4.34556C13.4402 4.24514 13.4402 4.13697 13.4728 4.03654C13.5099 3.92238 13.6089 3.82338 13.8069 3.62537L14.8005 2.63179C15.1779 2.25435 15.4931 1.93918 15.7715 1.70279C16.062 1.4562 16.3616 1.25155 16.7216 1.13459Z\" fill=\"currentColor\"/>
          <path d=\"M12.7462 5.8174C12.5482 5.61939 12.4492 5.52038 12.3351 5.48329C12.2346 5.45066 12.1265 5.45066 12.026 5.48329C11.9119 5.52038 11.8129 5.61939 11.6149 5.8174L2.80848 14.6237C2.6511 14.7809 2.51197 14.9198 2.39733 15.0841C2.29646 15.2286 2.21292 15.3845 2.14843 15.5485C2.07511 15.7349 2.03611 15.9294 1.99191 16.1498L1.09829 20.5896C1.06307 20.7644 1.02735 20.9417 1.01102 21.0924C0.99374 21.2519 0.983801 21.4866 1.08453 21.7304C1.21142 22.0375 1.45538 22.2815 1.76251 22.4084C2.00632 22.5091 2.24097 22.4992 2.40048 22.4819C2.55119 22.4656 2.72849 22.4298 2.90331 22.3946L7.34314 21.501C7.56352 21.4568 7.75799 21.4178 7.94443 21.3445C8.10843 21.28 8.2643 21.1965 8.40881 21.0956C8.57309 20.9809 8.71324 20.8406 8.87206 20.6815L17.6755 11.8781C17.8735 11.68 17.9725 11.581 18.0096 11.4669C18.0423 11.3665 18.0423 11.2583 18.0096 11.1579C17.9725 11.0437 17.8735 10.9447 17.6755 10.7467L12.7462 5.8174Z\" fill=\"currentColor\"/>
        </svg>
...
{% endif %}", "C:\\OSPanel\\domains\\inventpro-test\\themes\\invent-pro\\partials\\global\\bottom-bar.htm", "");
    }
