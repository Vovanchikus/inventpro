  ...
  <div class=\"main-box__top\">
    ...
    <div class=\"main-box__count\">
      Всього на складі: <span class=\"label--extra-sm label--secondary\">";
            // line 69
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("stockProductsCount", $context)) ? (Twig\Extension\CoreExtension::default($this->sandbox->ensureToStringAllowed(($context["stockProductsCount"] ?? null), 69, $this->source), 0)) : (0)), "html", null, true);
            yield "</span>
    </div>
...
{% if this.page.url == '/warehouse' %}
  ...
  <div class=\"main-box__top\">
    ...
    <div class=\"main-box__count\">
      Всього на складі: <span class=\"label--extra-sm label--secondary\">{{ stockProductsCount|default(0) }}</span>
    </div>
...
{# overlay-scroll подключается в layout/default.htm через assets/js/core/overlay-scroll.js #}", "C:\\OSPanel\\domains\\inventpro-test\\themes\\invent-pro\\partials\\global\\main-box.htm", "");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = ["escape" => 27, "length" => 30, "default" => 69];
        static $functions = [];

        try {
            $this->sandbox->checkSecurity(
                ['if', 'for'],
                ['escape', 'length', 'default'],
                [],
                $this->source
            );
