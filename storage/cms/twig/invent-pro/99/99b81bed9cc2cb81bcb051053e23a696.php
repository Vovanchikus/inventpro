...
/* C:\OSPanel\domains\inventpro-test\themes\invent-pro\pages\edit-operation.htm */
class __TwigTemplate_91a1514114749105a54f8b7153244973 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        if ((($context["user"] ?? null) && CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "isInGroup", ["admin"], "method", false, false, true, 1))) {
            // line 2
            yield "
<div class=\"container--sm box--light\">
  ...
  <form data-request=\"onEditOperation\" data-request-flash class=\"operation-form__content\" id =\"editOperationForm\" enctype=\"multipart/form-data\" data-request-files>
    ...
    <input type=\"hidden\" name=\"operation_id\" value=\"";
            // line 9
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["operation"] ?? null), "id", [], "any", false, false, true, 9), 9, $this->source), "html", null, true);
            yield "\">
    ...
    <div class=\"operation-form__type-box\">
      ";
          ...
          <input type=\"radio\" name=\"type_id\" value=\"";
                // line 14
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["type"], "id", [], "any", false, false, true, 14), 14, $this->source), "html", null, true);
                yield "\" hidden>
          <span class=\"operation-form__type-box__name\">";
                // line 15
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["type"], "name", [], "any", false, false, true, 15), 15, $this->source), "html", null, true);
                yield "</span>
        </label>
      ";
            }
...
";
            ...
            // line 187
            yield "    <p>У вас нет прав для редактирования операций.</p>
";
        }
        yield from [];
    }
    ...
    {
        return "C:\\OSPanel\\domains\\inventpro-test\\themes\\invent-pro\\pages\\edit-operation.htm";
    }
    ...
    {
        return array (  268 => 187,  246 => 167,  237 => 159,  229 => 152,  226 => 150,  223 => 148,  175 => 101,  168 => 95,  165 => 93,  162 => 91,  139 => 69,  124 => 55,  97 => 29,  86 => 19,  84 => 18,  75 => 15,  71 => 14,  68 => 13,  64 => 12,  58 => 9,  51 => 5,  46 => 2,  44 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{% if user and user.isInGroup('admin') %}
...
{% endif %}", "C:\\OSPanel\\domains\\inventpro-test\\themes\\invent-pro\\pages\\edit-operation.htm", "");
    }
    
    public function checkSecurity()
    {
        static $tags = ["if" => 1, "for" => 12];
        static $filters = ["escape" => 5, "slice" => 12];
        static $functions = [];
